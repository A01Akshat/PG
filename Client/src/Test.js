...
const Test = () => {
    ...
    useEffect(() => {
        ...
        axios.get("https://pgbackend.adityachoudhury.com/api/college", config)
            .then((res) => {
                if (res.status === 200) {
                    console.log(res);
                    toast("DONE")
            ...
            <div style={{ display: "grid", gridTemplateColumns: "auto auto auto", alignItems: "center", justifyContent: "center" }}>
                ...
                <div style={{ height: "260px", width: "300px", border: "2px solid black", margin: "1rem", borderRadius: "19px" }}>
                    ...
                    <div style={{ margin: "1px", padding: "7px", fontSize: "14.5px" }}>
                        <div style={{ display: "flex", flexDirection: "row" }}><h3>Price:₹1000</h3>
                            <button style={{ marginLeft: "11.5rem" }} onClick={toggleFunction}>
                                {fill ?
