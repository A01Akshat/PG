            ...
            <div className="rect-box">
                <div className="wrap">
                    ...
                    <div className="info_div  text-lg">
                        <h1 style={{ marginTop: "-36rem" }}>PG's Name: <span className="text-lg" style={{ marginLeft: "3.8rem", fontWeight: "600" }}>{data.name}</span></h1>
                        ...
                        <h1 style={{ marginTop: "1.7rem" }}>Amenities:
                            <div style={{ display: "flex", flexDirection: "row", flexWrap:"wrap", marginLeft: "9.5rem", marginTop: "-2rem", gap: "14px", fontWeight: "600" }}>
                        ...
                        <h1 style={{ marginTop: "2rem" }}>Furnished:<span className="text-lg Amne" style={{ marginLeft: "4.5rem", fontWeight: "600" }}>Semi-Furnished</span></h1>
                        <h1 style={{ marginTop: "1rem"}}>Bathroom:<span className="text-lg" style={{ marginLeft: "5.5rem", fontWeight: "600" }}>Attached</span></h1>
                    </div>
                </div>
